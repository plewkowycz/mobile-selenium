    ...
    def search_for(self, query: str) -> SearchPage:
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    element = self.wait.wait_for_clickable(
                        self.SEARCH_INPUT_FALLBACK, timeout=3
                    )
        ...
        try:
            ...
            try:
                ...
                videos_tab_text = self.driver.find_element(
                    By.XPATH, "//*[self::a or self::span][contains(text(), 'Video')]"
                )
        ...
        try:
            ...
            for i in range(times):
                ...
                video_cards = self.driver.find_elements(
                    By.CSS_SELECTOR,
                    "a[href*='/videos/'], button[aria-label*='Live with']",
                )
